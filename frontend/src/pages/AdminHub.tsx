...
import { BookOpen, FileQuestion, FileUp, Users } from "lucide-react";
...
export function AdminHub() {
  ...
  const items = [
    ...
    { to: "/surveys-admin", label: "Questionnaires", description: "Templates, event activation, and results.", icon: FileQuestion, show: true },
